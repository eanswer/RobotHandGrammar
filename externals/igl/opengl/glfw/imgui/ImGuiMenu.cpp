...
//     droid_sans_compressed_size, font_size * hidpi_scaling_);
  io.Fonts->AddFontFromFileTTF(PROJECT_SOURCE_DIR "/externals/imgui/misc/fonts/Cousine-Regular.ttf", font_size * hidpi_scaling_);
...
{
  float menu_width = 260.f * menu_scaling();
  ImGui::SetNextWindowPos(ImVec2(0.0f, 0.0f), ImGuiSetCond_FirstUseEver);
//   ImGui::SetNextWindowSize(ImVec2(0.0f, 0.0f), ImGuiSetCond_FirstUseEver);
  ImGui::SetNextWindowSize(ImVec2(menu_width, 800.f), ImGuiSetCond_FirstUseEver);
//   ImGui::SetNextWindowSizeConstraints(ImVec2(menu_width / 2., -1.0f), ImVec2(menu_width * 2., -1.0f));
  
  bool _viewer_menu_visible = true;
  ImGui::Begin(
    //   "Viewer", &_viewer_menu_visible,
      menu_name_.c_str(), &_viewer_menu_visible,
